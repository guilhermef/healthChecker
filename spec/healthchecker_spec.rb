...
describe 'Healthchecker App' do
  ...
  it "config on json format" do
    ...
    get '/config'
    last_response.should be_ok
    last_response.body.should == "{\"projects\":{\"my-200-project\":{\"id\":\"200-project\",\"name\":\"my-200-project\",\"url\":\"http://www.return.200.com/healthcheck\"},\"my-404-project\":{\"id\":\"404-project\",\"name\":\"my-404-project\",\"url\":\"http://www.return.404.com/healthcheck\"},\"my-500-project\":{\"id\":\"500-project\",\"name\":\"my-500-project\",\"url\":\"http://www.return.500.com/healthcheck\"}}}"
  end
